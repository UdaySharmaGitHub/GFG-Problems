# GFG Problems — DSA Solutions in C++

A curated collection of **solved Data Structures & Algorithms problems** from [GeeksforGeeks](https://www.geeksforgeeks.org/), including **Problem of the Day (POTD)** submissions — all implemented in **C++**.
...
| Folder | Description |
|--------|-------------|
| 🏫 [School Problems](School%20Problems/) | Foundational math, strings, I/O |
| 🔵 [Basic Problems](Basic%20Problems/) | Arrays, linked lists, trees, basic patterns |
| 🟢 [Easy Problems](Easy%20Problems/) | Sorting, searching, BST, stack, queue |
| 🟡 [Medium Problems](Medium%20Problems/) | DP, graphs, advanced trees, sliding window |
| 🔴 [Hard Problems](Hard%20Problems/) | Complex DP, advanced graphs, segment trees |

## Repository Structure

```
GFG-Problems/
├── School Problems/      # Foundational math, strings, I/O
├── Basic Problems/       # Arrays, linked lists, trees, basic patterns
├── Easy Problems/        # Sorting, searching, BST, stack, queue
├── Medium Problems/      # DP, graphs, advanced trees, sliding window
├── Hard Problems/        # Complex DP, advanced graphs, segment trees
└── README.md
```
...
> 📁 Path: [School Problems](School%20Problems/)
...
| Patterns | Pattern 1–13 (multiple star/number patterns) |
| Miscellaneous | Leap Year, Logical Operators, C++ STL Vector |

> 📁 Path: [Basic Problems](Basic%20Problems/)
...
| Patterns | Pattern 2–21 (various shapes) |

> 📁 Path: [Easy Problems](Easy%20Problems/)
...
> 📁 Path: [Medium Problems](Medium%20Problems/)
...
> 📁 Path: [Hard Problems](Hard%20Problems/)
...
|---------------------------|-----------------|
| Arrays & Strings | School → Hard |
| Linked Lists (Singly, Doubly, Circular) | Basic → Hard |
| Stack & Queue | Basic → Medium |
| Binary Trees & BST | Basic → Hard |
| Graphs | Medium → Hard |
| Dynamic Programming | Medium → Hard |
| Greedy Algorithms | Easy → Medium |
| Sorting & Searching | Basic → Medium |
| Sliding Window & Two Pointers | Easy → Medium |
| Matrix Operations | School → Medium |
| Bit Manipulation | Easy → Medium |
| Math & Number Theory | School → Medium |
...
```bash
git checkout -b add/<Problem_Name>
```

### 3. Add Your Solution

- Place the file in the **correct difficulty folder** (`School Problems/`, `Basic Problems/`, `Easy Problems/`, `Medium Problems/`, or `Hard Problems/`)
- Follow the [naming convention](#naming-convention) below
- Make sure your file compiles without errors

### 4. Verify It Compiles

```bash
g++ -std=c++17 -Wall -o test "Easy Problems/Your_Problem_Name.cpp"
```
...
git push origin add/<Problem_Name>
```
...
- Use **Title_Case** for each word
- Match the **exact problem name** from GFG as closely as possible
- `.cpp` extension only — do not commit `.exe` or compiled binaries
...
This repository is for **educational purposes**. All problem statements belong to [GeeksforGeeks](https://www.geeksforgeeks.org/). Solutions and code in this repository are open for learning and reference.

---

> ⭐ If this repository helped you, consider starring it to help others find it!
